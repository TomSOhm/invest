...
1. **Read** `docs/PROJECT_BRIEF.md` for architecture context
2. **Check** which strategy applies (PEA vs Global)
3. **Follow** the methodology in `docs/METHODOLOGY.md`
4. **Use** settings from `settings.yaml` for thresholds and weights
5. **Reference** `docs/DATA_SOURCES.md` for available APIs
