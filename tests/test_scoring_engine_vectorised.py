...
def small_universe() -> pd.DataFrame:
    ...
    data = [
        # Six software stocks
        {"Ticker": "S1", "Sector": "Technology", "PE": 15, "PB": 4, "PS": 5, "PFCF": 20,
         "EV_EBITDA": 12, "EV_Sales": 4, "ROE": 0.20, "ROA": 0.10, "ROIC": 0.15,
         "OperatingMargin": 0.30, "NetMargin": 0.20, "FCFMargin": 0.18, "RevenueGrowth": 0.20,
         "DivYield": 0.005, "PayoutRatio": 0.10, "Beta": 1.1, "InterestCoverage": 25.0,
         "CurrentRatio": 1.5, "DebtEquity": 0.4, "EBITDA": 1e9, "TotalDebt": 5e8, "Cash": 1e9,
         "Price": 100, "Shares": 1e9, "TotalEquity": 5e9, "NetIncome": 5e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 5e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 1e9,
         "MarketCap": 1e11, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.6},
        {"Ticker": "S2", "Sector": "Technology", "PE": 20, "PB": 5, "PS": 6, "PFCF": 25,
         "EV_EBITDA": 15, "EV_Sales": 5, "ROE": 0.18, "ROA": 0.09, "ROIC": 0.13,
         "OperatingMargin": 0.27, "NetMargin": 0.18, "FCFMargin": 0.15, "RevenueGrowth": 0.18,
         "DivYield": 0.0, "PayoutRatio": 0.0, "Beta": 1.2, "InterestCoverage": 20.0,
         "CurrentRatio": 1.4, "DebtEquity": 0.5, "EBITDA": 1e9, "TotalDebt": 5e8, "Cash": 8e8,
         "Price": 100, "Shares": 1e9, "TotalEquity": 5e9, "NetIncome": 5e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 5e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 1e9,
         "MarketCap": 1e11, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.6},
        {"Ticker": "S3", "Sector": "Technology", "PE": 25, "PB": 6, "PS": 7, "PFCF": 30,
         "EV_EBITDA": 18, "EV_Sales": 6, "ROE": 0.16, "ROA": 0.08, "ROIC": 0.11,
         "OperatingMargin": 0.24, "NetMargin": 0.16, "FCFMargin": 0.13, "RevenueGrowth": 0.15,
         "DivYield": 0.01, "PayoutRatio": 0.20, "Beta": 1.3, "InterestCoverage": 15.0,
         "CurrentRatio": 1.3, "DebtEquity": 0.6, "EBITDA": 1e9, "TotalDebt": 5e8, "Cash": 6e8,
         "Price": 100, "Shares": 1e9, "TotalEquity": 5e9, "NetIncome": 5e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 5e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 1e9,
         "MarketCap": 1e11, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.6},
        {"Ticker": "S4", "Sector": "Technology", "PE": 30, "PB": 7, "PS": 8, "PFCF": 35,
         "EV_EBITDA": 21, "EV_Sales": 7, "ROE": 0.14, "ROA": 0.07, "ROIC": 0.09,
         "OperatingMargin": 0.21, "NetMargin": 0.14, "FCFMargin": 0.11, "RevenueGrowth": 0.12,
         "DivYield": 0.0, "PayoutRatio": 0.0, "Beta": 1.4, "InterestCoverage": 12.0,
         "CurrentRatio": 1.2, "DebtEquity": 0.7, "EBITDA": 1e9, "TotalDebt": 5e8, "Cash": 4e8,
         "Price": 100, "Shares": 1e9, "TotalEquity": 5e9, "NetIncome": 5e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 5e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 1e9,
         "MarketCap": 1e11, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.6},
        {"Ticker": "S5", "Sector": "Technology", "PE": 35, "PB": 8, "PS": 9, "PFCF": 40,
         "EV_EBITDA": 24, "EV_Sales": 8, "ROE": 0.12, "ROA": 0.06, "ROIC": 0.07,
         "OperatingMargin": 0.18, "NetMargin": 0.12, "FCFMargin": 0.09, "RevenueGrowth": 0.10,
         "DivYield": 0.0, "PayoutRatio": 0.0, "Beta": 1.5, "InterestCoverage": 8.0,
         "CurrentRatio": 1.1, "DebtEquity": 0.8, "EBITDA": 1e9, "TotalDebt": 5e8, "Cash": 3e8,
         "Price": 100, "Shares": 1e9, "TotalEquity": 5e9, "NetIncome": 5e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 5e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 1e9,
         "MarketCap": 1e11, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.6},
        {"Ticker": "S6", "Sector": "Technology", "PE": 50, "PB": 10, "PS": 12, "PFCF": 60,
         "EV_EBITDA": 35, "EV_Sales": 10, "ROE": 0.08, "ROA": 0.04, "ROIC": 0.05,
         "OperatingMargin": 0.12, "NetMargin": 0.08, "FCFMargin": 0.06, "RevenueGrowth": 0.05,
         "DivYield": 0.0, "PayoutRatio": 0.0, "Beta": 1.8, "InterestCoverage": 5.0,
         "CurrentRatio": 1.0, "DebtEquity": 1.0, "EBITDA": 1e9, "TotalDebt": 5e8, "Cash": 2e8,
         "Price": 100, "Shares": 1e9, "TotalEquity": 5e9, "NetIncome": 5e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 5e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 1e9,
         "MarketCap": 1e11, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
        ...
        {"Ticker": "U1", "Sector": "Utilities", "PE": 12, "PB": 1.5, "PS": 1, "PFCF": 14,
         "EV_EBITDA": 7, "EV_Sales": 1.5, "ROE": 0.10, "ROA": 0.05, "ROIC": 0.06,
         "OperatingMargin": 0.20, "NetMargin": 0.08, "FCFMargin": 0.10, "RevenueGrowth": 0.03,
         "DivYield": 0.04, "PayoutRatio": 0.50, "Beta": 0.5, "InterestCoverage": 5.0,
         "CurrentRatio": 1.2, "DebtEquity": 1.5, "EBITDA": 2e9, "TotalDebt": 3e9, "Cash": 5e8,
         "Price": 50, "Shares": 1e9, "TotalEquity": 4e9, "NetIncome": 4e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 4e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 5e8,
         "MarketCap": 5e10, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.4},
        {"Ticker": "U2", "Sector": "Utilities", "PE": 14, "PB": 1.6, "PS": 1.1, "PFCF": 16,
         "EV_EBITDA": 8, "EV_Sales": 1.6, "ROE": 0.11, "ROA": 0.05, "ROIC": 0.07,
         "OperatingMargin": 0.21, "NetMargin": 0.09, "FCFMargin": 0.11, "RevenueGrowth": 0.04,
         "DivYield": 0.045, "PayoutRatio": 0.55, "Beta": 0.55, "InterestCoverage": 6.0,
         "CurrentRatio": 1.3, "DebtEquity": 1.4, "EBITDA": 2e9, "TotalDebt": 3e9, "Cash": 5e8,
         "Price": 50, "Shares": 1e9, "TotalEquity": 4e9, "NetIncome": 4e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 4e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 5e8,
         "MarketCap": 5e10, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.4},
        {"Ticker": "U3", "Sector": "Utilities", "PE": 16, "PB": 1.7, "PS": 1.2, "PFCF": 18,
         "EV_EBITDA": 9, "EV_Sales": 1.7, "ROE": 0.12, "ROA": 0.06, "ROIC": 0.08,
         "OperatingMargin": 0.22, "NetMargin": 0.10, "FCFMargin": 0.12, "RevenueGrowth": 0.05,
         "DivYield": 0.05, "PayoutRatio": 0.60, "Beta": 0.6, "InterestCoverage": 7.0,
         "CurrentRatio": 1.4, "DebtEquity": 1.3, "EBITDA": 2e9, "TotalDebt": 3e9, "Cash": 5e8,
         "Price": 50, "Shares": 1e9, "TotalEquity": 4e9, "NetIncome": 4e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 4e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 5e8,
         "MarketCap": 5e10, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
         "GrossMargin": 0.4},
        {"Ticker": "U4", "Sector": "Utilities", "PE": 20, "PB": 1.9, "PS": 1.4, "PFCF": 22,
         "EV_EBITDA": 11, "EV_Sales": 2.0, "ROE": 0.07, "ROA": 0.03, "ROIC": 0.05,
         "OperatingMargin": 0.18, "NetMargin": 0.06, "FCFMargin": 0.08, "RevenueGrowth": 0.01,
         "DivYield": 0.035, "PayoutRatio": 0.45, "Beta": 0.7, "InterestCoverage": 4.0,
         "CurrentRatio": 1.0, "DebtEquity": 1.7, "EBITDA": 2e9, "TotalDebt": 3e9, "Cash": 5e8,
         "Price": 50, "Shares": 1e9, "TotalEquity": 4e9, "NetIncome": 4e8,
         "TotalAssets": 1e10, "Revenue": 5e9, "EBIT": 1e9,
         "CurrentAssets": 4e9, "CurrentLiabilities": 3e9, "RetainedEarnings": 5e8,
         "MarketCap": 5e10, "Shares_PriorYear": 1e9, "OperatingCashflow": 1e9,
